...
export default function P5Sketch({ k1, k2, t }) {
  ...
  `;
        ...
        let circlePoints = [];
        let circleCoeffs = { a: 1, g: 0, f: 0, c: -9 }; // Default: x² + y² - 9 = 0 (circle with radius 3)
        ...
        P.setup = () => {
          ...
          P.noStroke();
          circlePoints = getGeneralCircleCoordinates(
            circleCoeffs.a,
            circleCoeffs.g,
            circleCoeffs.f,
            circleCoeffs.c,
        ...
        P.draw = () => {
          ...
          P.textSize(16);
          P.textStyle(P.BOLD);
          P.text("Interactive Circle Equation:", 20, 25);

          P.textStyle(P.NORMAL);
          P.textSize(14);
          P.text(`ax² + ay² + 2gx + 2fy + c = 0`, 20, 50);
          ...
          if (info.valid) {
            ...
            P.text(
              `Standard form: (x${info.center[0] >= 0 ? "-" : "+"}${Math.abs(
                info.center[0]
              ).toFixed(2)})² + (y${info.center[1] >= 0 ? "-" : "+"}${Math.abs(
                info.center[1]
